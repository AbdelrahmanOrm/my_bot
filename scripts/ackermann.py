...
class BotTeleopKeyboardNode(Node):
    def __init__(self):
        super().__init__("my_bot_teleop_keyboard_node")

        # Load parameters from the parameter file
        self.declare_parameters(
            namespace='',
            parameters=[
                ('velocity_increase_rate', None),
                ('steering_increase_rate', None),
                ('max_velocity', None),
        ...
        self.velocity_increase_rate = self.get_parameter('velocity_increase_rate').value
        self.steering_increase_rate = self.get_parameter('steering_increase_rate').value
...
def main(args):
    ...
    teleop_node = BotTeleopKeyboardNode()
